...
*In the following sections you will get to know [**Glue42 Enterprise**](https://glue42.com/enterprise/) by using the trial demo edition. If you haven't already done so, download the trial installer from the [official Glue42 site](https://glue42.com) and see the [How to Install](../install/index.html) section. Keep in mind that all functionalities and UIs of [**Glue42 Enterprise**](https://glue42.com/enterprise/) can be fully redesigned and customized to suit your specific needs and requirements.*
