...
- Extended the `focusWindow()` method in the Swimlane API to work in the context of [Activities](../../../glue42-concepts/data-sharing-between-apps/activities/overview/index.html).
